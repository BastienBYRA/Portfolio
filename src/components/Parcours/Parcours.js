  ...
  render() {
    return (
      ...
      >
        ...
        <p className="mt-6 text-lg px-8 text-center">
          Cela fait maintenant 5 ans que je suis dans le vaste monde de
          l'informatique, dont 2 ans de spécialisation dans l'infrastructure
          réseau et 3 ans de spécialisation dans le développement de solution
          informatique.
        </p>
